// Ruta: src/data/chileRegiones.js
// Regiones y comunas de Chile, para los selects de dirección (registro y
// perfil). Se usan los nombres de uso común (ej. "Metropolitana" en vez de
// "Metropolitana de Santiago"), porque así es como ya estaban guardadas las
// direcciones existentes antes de que esto fuera un select.
const REGIONES_CHILE = [
    ...
    {
        region: 'Los Ríos',
        comunas: ['Corral', 'Futrono', 'Lago Ranco', 'Lanco', 'Los Lagos', 'Máfil', 'Mariquina', 'Paillaco', 'Panguipulli', 'Río Bueno', 'Valdivia'],
    },
    {
        region: 'Los Lagos',
        comunas: ['Ancud', 'Calbuco', 'Castro', 'Chaitén', 'Chonchi', 'Cochamó', 'Curaco de Vélez', 'Dalcahue', 'Fresia', 'Frutillar', 'Futaleufú', 'Hualaihué', 'Llanquihue', 'Los Muermos', 'Maullín', 'Osorno', 'Puerto Montt', 'Puerto Octay', 'Puerto Varas', 'Puqueldón', 'Purranque', 'Puyehue', 'Queilén', 'Quellón', 'Quemchi', 'Quinchao', 'Río Negro', 'San Juan de la Costa', 'San Pablo'],
    },
    {
        region: 'Aysén',
...
export default REGIONES_CHILE;

export const getComunas = (region) => {
    const encontrada = REGIONES_CHILE.find(r => r.region === region);
