 ...
 * Sigue la misma estructura que el 'BookService' de la guía [cite: 798-825].
...
public class AuthService {
    ...
    // @Autowired: Spring inyecta una instancia del Repositorio de Usuarios [cite: 811]
    @Autowired
    ...
    // TUTOR: Más adelante, aquí también añadiremos la lógica para el LOGIN
    // (verificar el email y la contraseña encriptada).
}